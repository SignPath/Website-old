...
* The project may not contain or build upon any proprietary non open-source code (espeically code published by a maintainer or an affiliated person/organization; platform, programming languages and runtimes are excluded)
