# Code signing breaches in supply chain attacks
...
* The backdoored version downloaded **additional payload for pre-determined attack targets** from a Command and Control (C2) server (second stage attack)
